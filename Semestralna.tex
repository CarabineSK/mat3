...
definovaná funkcia $f(x, y, \Delta y, \Delta ^{2}y, ..., \Delta ^{k}y)$. Rovnica tvaru
$$f(x, y, \Delta y, \Delta ^{2}y, ..., \Delta ^{k}y) = 0 \text{ ,}$$
...
definovaná funkcia
$$g(x, y_{x}, y_{x+1}, ..., y_{x+k})\text{, kde }y_{x+j} = \varphi(x + j) j = 0, 1, 2, ..., k\text{.}$$
\end{defin}

Rovnicu tvaru
$$g(x, y_{x}, y_{x+1}, ..., y_{x+k}) = 0\text{,}$$
