...
\end{tabbing} 
\end{spacing}kde $ x_{1} $ je prvým členom postupnosti. \\
Vychádzajúc z $ a + b > 0 $ nech $ 1 + \frac{b}{a} = \alpha > 0$\\
...
môžeme zapísať ako $ X \sim Bin(z,\frac{a}{a-1}) $.%Peto screen 46 koniec
\newpage %Kecy z doc
\section{Využitie rozdelení pravdepodobností v poisťovníctve a teórii rizika} %Doc file stuff !!! -.-
...
\subsection{Geometrické rozdelenie $ Ge(p) $}
